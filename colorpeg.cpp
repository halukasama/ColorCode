...
bool ColorPeg::GetIsDragged() const
{
    return mIsDragged;
}
...
void ColorPeg::SetPaused(const bool b)
{
    bool enable;
    if (b)
    {
        mEnabledBuff = isEnabled();
        enable = false;
    }
    else
    {
...
void ColorPeg::paint(QPainter* painter, const QStyleOptionGraphicsItem*, QWidget*)
{
